...
async function displayData(query, variables) {
    try {
...
// Call the function to display data for each query without a delay
displayData(query1, variables);
displayData(query2, variables);
displayData(query3, variables);
